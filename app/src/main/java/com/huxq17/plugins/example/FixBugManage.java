...
//        }
    ...
    public static void injectDexAtFirst(String dexPath, String defaultDexOptPath, Context context)
            throws NoSuchFieldException, IllegalAccessException,
            ClassNotFoundException {
        DexClassLoader dexClassLoader = new DexClassLoader(dexPath,
                defaultDexOptPath, dexPath, getPathClassLoader(context));// 把dexPath文件补丁处理后放入到defaultDexOptPath目录中
        Object baseDexElements = getDexElements(getPathList(getPathClassLoader(context)));// 获取当面应用Dex的内容
        ...
        Object pathList = getPathList(getPathClassLoader(context));// 获取当前的patchList对象
    ...
    private static PathClassLoader getPathClassLoader(Context context) {
        PathClassLoader pathClassLoader = (PathClassLoader) context.getClassLoader();// 获取类加载器
